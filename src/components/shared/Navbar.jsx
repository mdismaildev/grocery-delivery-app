    ...
    <div className="border-b border-[#E5E7EB] bg-white">
      <div className="flex items-center justify-between navbar bg-base-100 px-4 md:px-8 py-3  container mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <NavLink
            to="/"
            className="flex items-center gap-2 text-2xl font-medium text-[#1B3022]"
          >
            <img src={svg} alt="" />
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="flex items-center gap-8 text-lg text-[#52525C] font-normal">
            <li>
              <NavLink
                to="/"
                className={({ isActive }) =>
        ...
        <div className="navbar-end w-full lg:w-auto flex-1 lg:flex-none gap-3 sm:gap-6 justify-end">
          ...
          <div className="hidden md:flex relative w-full max-w-md">
            ...
            <input
              ...
              className="w-full bg-[#FFF7ED] text-sm text-[#1B3022]/50 rounded-full py-2.5 pl-11 pr-4 focus:outline-none ring-1 ring-orange-200"
            />
          </div>
          ...
          <button className="btn btn-ghost btn-circle border-none">
            <div className="indicator">
              <span className="indicator-item badge bg-[#F97316] text-white  w-5 h-5 p-0 text-xs rounded-full">
                5
              </span>
